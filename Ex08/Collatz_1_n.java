...
public class Collatz_1_n {
  ...
  private static Result check(BigInteger n, Set<BigInteger> visited, ArrayList<BigInteger> sequence) {
...
class Result {
  ...
  public Result(List<BigInteger> sequence, boolean valid) {
